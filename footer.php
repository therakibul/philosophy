...
<section class="s-extra">
    ...
    <div class="row bottom tags-wrap">
        <div class="col-full tags">
            <?php  
                $footer_taxonomy_title = apply_filters("footer_taxonomy_title", __("Tags", "philosophy"));
                $footer_taxonomy_terms = apply_filters("footer_taxonomy_terms", get_tags());
            ?>
            <h3><?php echo $footer_taxonomy_title;?></h3>

            <div class="tagcloud">
                <?php 
                    foreach($footer_taxonomy_terms as $term){
